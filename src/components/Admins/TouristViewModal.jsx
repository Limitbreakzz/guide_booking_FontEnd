...
const TouristViewModal = ({ tourist, isOpen, onClose }) => {
        ...
        <>
          ...
          >
            ...
            <div className="sticky top-0 bg-white border-b border-slate-200 px-8 py-6 flex items-center justify-between">
              <h2 className="text-2xl font-black text-[#37101A]">รายละเอียดนักท่องเที่ยว</h2>
              <button
                onClick={onClose}
            ...
            <div className="px-8 py-6 space-y-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-black text-[#37101A]">{tourist.name}</h3>
                  <p className="text-sm text-slate-500 font-semibold">Registered Member</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  ...
                  <p className="text-base font-semibold text-[#37101A]">{tourist.email}</p>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  ...
                  <p className="text-base font-semibold text-[#37101A]">{tourist.tel || "—"}</p>
                </div>
              </div>
            </div>
...
export default TouristViewModal;

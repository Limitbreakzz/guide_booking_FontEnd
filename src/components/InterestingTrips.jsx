...
const TopTrips = () => {
    ...
    if (loading) {
        return <div className="py-20 text-center text-gray-500">กำลังโหลดข้อมูล...</div>;
    }
    ...
    return (
        <section className="mt-16 px-4 max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-8">
                <div>
                    <h2 className="text-2xl md:text-2xl font-bold text-[#37101A]">ทริปที่น่าสนใจ</h2>
                    <p className="text-sm md:text-md text-gray-500 mt-1">ทริปคุณภาพ ที่นักท่องเที่ยวเลือกมากที่สุด</p>
                </div>
                <button
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                            <div className="text-white flex-1 mr-4">
                                ...
                                <p className="text-sm opacity-80">{trip.province?.name || "ไม่ระบุสถานที่"}</p>
